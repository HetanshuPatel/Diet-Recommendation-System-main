        ...
        if recommendations!=None:
            ...
            with col2:
                try:
                    ...
                    #selected_recipe_name = st.selectbox('Select a recipe', [recipe['Name'] if 'Name' in recipe else 'Unknown' for recipe in recommendations])
                    # Check if each item in recommendations is a dictionary before accessing it
                except:
                    pass
